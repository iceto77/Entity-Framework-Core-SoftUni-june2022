namespace Footballers
{
    ...
    public class StartUp
    {
        ...
        {
            var coaches = DataProcessor.Deserializer.ImportCoaches(context, File.ReadAllText(baseDir + "coaches.xml"));

            PrintAndExportEntityToFile(coaches, exportDir + "Actual Result - ImportCoaches.txt");

            var teams = DataProcessor.Deserializer.ImportTeams(context, File.ReadAllText(baseDir + "teams.json"));
